...
class Project extends Model {
	 ...
	 * @return mixed
	 */
	public function getProjectDocumentRoot() {
		return $this->docroot;
	}
	...
	public function getProjectDB() {
		return str_replace("/public", "/data/db/default.sql3", $this->getProjectDocumentRoot());
	}
	...
	public function getProjectPath() {
		return str_replace("/public", "", $this->getProjectDocumentRoot());
	}
