...
(function(){
	...
	var // jQuery and jQueryUI version
		...
		load = function() {
			require(
				[
					'elfinder'
					, '/js/elfinder/extras/editors.default.min'               // load text, image editors
					, 'elFinderConfig'
	...
	if (! require.defined('elFinderConfig')) {
		define('elFinderConfig', {
			...
			defaultOpts : {
				url : '/~user3/user-addons/filemanager/elfinder/php/connector.minimal.php' // connector URL (REQUIRED)
				,commandsOptions : {
					edit : {
						extraOptions : {
